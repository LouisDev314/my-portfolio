...
export const Cover = ({ children, className }: { children?: React.ReactNode; className?: string }) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className="relative rounded-xl hover:bg-neutral-900  group/cover inline-block dark:bg-neutral-900 bg-neutral-100 px-2 py-2  transition duration-200">
      <AnimatePresence>
        {hovered && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <motion.span
        ...
        className={cn('inline-block text-neutral-900 relative z-20 transition duration-200', className)}>
        {children}
      </motion.span>
    </div>
  );
